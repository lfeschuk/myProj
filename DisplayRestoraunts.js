...
import ListThumbnailExample from './ListThumbnailExample'
  ...
  class DisplayRestoraunts extends React.Component {
...
handleDataComponentDidMount = ()=>{
 ...
 componentDidMount() 
 {
   DataBaseHandler.getListOfRests(this.set_objects)
...
set_objects = (objects_to_display) => {
  ...
  createListElement = (item) => {
     return(
       <ListThumbnailExample is_rest style={styles.item} delivery={item} navigation={this.props.navigation}></ListThumbnailExample>
...
var styles = StyleSheet.create({
 ...
 export default DisplayRestoraunts
